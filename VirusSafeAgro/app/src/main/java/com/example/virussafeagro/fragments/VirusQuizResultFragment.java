...
//        this.initializeViews();
        // test
        for (SingleChoiceQuestionModel s : this.singleChoiceQuestionModelList) {
            System.out.println("s question:" + s.getSingleChoiceQuestionContent());
        }
        // test
        for (MultipleChoiceQuestionModel m : this.multipleChoiceQuestionModelList) {
            System.out.println("m question:" + m.getMultipleChoiceQuestionContent());
        }
