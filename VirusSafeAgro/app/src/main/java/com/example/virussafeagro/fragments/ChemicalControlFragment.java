...
public class ChemicalControlFragment extends Fragment {
    ...
    public ChemicalControlFragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.view = inflater.inflate(R.layout.fragment_chemical_control, container, false);

        // get main activity
        this.mainActivity = (MainActivity) getActivity();
        // set title
        this.mainActivity.getTitleTextView().setText(R.string.fragment_chemical_control);
        // show back button
    ...
    private void initializeViews() {
        this.card1ImageButton = view.findViewById(R.id.imgbtn_card1_chemical_control);
        this.card2ImageButton = view.findViewById(R.id.imgbtn_card2_chemical_control);
        this.card3ImageButton = view.findViewById(R.id.imgbtn_card3_chemical_control);
        this.card4ImageButton = view.findViewById(R.id.imgbtn_card4_chemical_control);
        this.card5ImageButton = view.findViewById(R.id.imgbtn_card5_chemical_control);
        this.card6ImageButton = view.findViewById(R.id.imgbtn_card6_chemical_control);
        this.card7ImageButton = view.findViewById(R.id.imgbtn_card7_chemical_control);
        this.card8ImageButton = view.findViewById(R.id.imgbtn_card8_chemical_control);
        this.card9ImageButton = view.findViewById(R.id.imgbtn_card9_chemical_control);
        this.line1View = view.findViewById(R.id.v_horizontal_line1_chemical_control);
        this.line2View = view.findViewById(R.id.v_horizontal_line2_chemical_control);
        this.line3View = view.findViewById(R.id.v_horizontal_line3_chemical_control);
        this.line4View = view.findViewById(R.id.v_horizontal_line4_chemical_control);
        this.line5View = view.findViewById(R.id.v_horizontal_line5_chemical_control);
        this.line6View = view.findViewById(R.id.v_horizontal_line6_chemical_control);
        this.line7View = view.findViewById(R.id.v_horizontal_line7_chemical_control);
        this.line8View = view.findViewById(R.id.v_horizontal_line8_chemical_control);
        this.line9View = view.findViewById(R.id.v_horizontal_line9_chemical_control);
        this.card1hideRelativeLayout = view.findViewById(R.id.rl_card1_hide_chemical_control);
        this.card2hideRelativeLayout = view.findViewById(R.id.rl_card2_hide_chemical_control);
        this.card3hideRelativeLayout = view.findViewById(R.id.rl_card3_hide_chemical_control);
        this.card4hideRelativeLayout = view.findViewById(R.id.rl_card4_hide_chemical_control);
        this.card5hideRelativeLayout = view.findViewById(R.id.rl_card5_hide_chemical_control);
        this.card6hideRelativeLayout = view.findViewById(R.id.rl_card6_hide_chemical_control);
        this.card7hideRelativeLayout = view.findViewById(R.id.rl_card7_hide_chemical_control);
        this.card8hideRelativeLayout = view.findViewById(R.id.rl_card8_hide_chemical_control);
        this.card9hideRelativeLayout = view.findViewById(R.id.rl_card9_hide_chemical_control);
    }
