...
public class AppResources {
    ...
    public final static String FRAGMENT_TAG_DETECT = "virus_detect";
    public final static String FRAGMENT_TAG_TOMATO_DETECT = "tomato_detect";
    ...
    public final static String FRAGMENT_TAG_NUTRIENT_DETAIL_NEW = "nutrient_detail_new";
    ...
    public final static String FRAGMENT_DETECT = "detect";
