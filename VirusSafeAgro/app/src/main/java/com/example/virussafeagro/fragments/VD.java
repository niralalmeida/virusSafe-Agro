...
public class VD extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.view = inflater.inflate(R.layout.fragment_virus_detail_v1, container, false);
    ...
    private void initializeViews() {
        this.virusFullNameTextView = view.findViewById(R.id.tv_title_virus_full_name_virus_detail_v1);
        this.virusAbbreviationTextView = view.findViewById(R.id.tv_sub_title_abbreviation_virus_detail_v1);
        this.virusPictureImageView = view.findViewById(R.id.img_virus_picture_virus_detail_v1);
        this.descriptionTextView = view.findViewById(R.id.tv_description_virus_detail_v1);
        this.symptomsTextView = view.findViewById(R.id.tv_symptoms_virus_detail_v1);
        this.causesTextView = view.findViewById(R.id.tv_causes_virus_detail_v1);
        this.spreadTextView = view.findViewById(R.id.tv_spread_virus_detail_v1);
        this.preventionTextView = view.findViewById(R.id.tv_prevention_virus_detail_v1);
        this.distributionTextView = view.findViewById(R.id.tv_distribution_virus_detail_v1);
        this.takeQuizButton = view.findViewById(R.id.btn_take_quiz_virus_detail_v1);
    }
    ...
    private void showVirusDetails() {
        ...
        if (!this.currentVirusModel.getVirusAbbreviation().isEmpty()) {
            LinearLayout linearLayoutForSubtitle = view.findViewById(R.id.ll_sub_title_abbreviation_virus_detail_v1);
        ...
        // description
        LinearLayout linearLayoutForDescription = view.findViewById(R.id.ll_description_virus_detail_v1);
        ...
        // symptom
        LinearLayout linearLayoutForSymptom = view.findViewById(R.id.ll_symptoms_virus_detail_v1);
        this.hideLinearLayoutIfItemIsEmpty(linearLayoutForSymptom, this.symptomsTextView, this.currentVirusModel.getSymptoms());

        // causes
        LinearLayout linearLayoutForCauses = view.findViewById(R.id.ll_causes_virus_detail_v1);
        this.hideLinearLayoutIfItemIsEmpty(linearLayoutForCauses, this.causesTextView, this.currentVirusModel.getCauses());

        // spread
        LinearLayout linearLayoutForSpread = view.findViewById(R.id.ll_spread_virus_detail_v1);
        this.hideLinearLayoutIfItemIsEmpty(linearLayoutForSpread, this.spreadTextView, this.currentVirusModel.getSpread());

        // prevention
        LinearLayout linearLayoutForPrevention = view.findViewById(R.id.ll_prevention_virus_detail_v1);
        ...
        // distribution
        LinearLayout linearLayoutForDistribution = view.findViewById(R.id.ll_distribution_virus_detail_v1);
